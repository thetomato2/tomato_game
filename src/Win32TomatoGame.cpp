...
DoControllerInput(GameInput& oldInput, GameInput& newInput, HWND hWnd)
{
	...
	// keyboard
	//
	ProcessKbdMsg(newInput.keyboard.A, ::GetKeyState(Keys::A) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.D, ::GetKeyState(Keys::D) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.S, ::GetKeyState(Keys::S) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.W, ::GetKeyState(Keys::W) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.Space, ::GetKeyState(Keys::Space) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.LShift, ::GetKeyState(Keys::LeftShift) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.P, ::GetKeyState(Keys::P) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.D1, ::GetKeyState(Keys::D1) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.D2, ::GetKeyState(Keys::D2) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.D3, ::GetKeyState(Keys::D3) & (1 << 15));
	ProcessKbdMsg(newInput.keyboard.D4, ::GetKeyState(Keys::D4) & (1 << 15));
