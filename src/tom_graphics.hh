...
// #Graphics Functions
 ...
 void draw_rect_outline(Texture *buffer, i32 min_x, i32 min_y, f32 max_x, f32 max_y,
                          i32 thickness, Color_u32 color);
 void draw_rect_outline(Texture *buffer, i32 min_x, i32 min_y, i32 max_x, i32 max_y,
...
#if 1
 void draw_rect_256(Texture *buffer, v2f origin, v2f x_axis, v2f y_axis, Texture *albedo,
                          v4f color = { 1.0f, 1.0f, 1.0f, 1.0f });
#endif
// normals and stuff
