...
set CommonCompilerFLagsDebug= /GS /W3 /Zc:wchar_t /Zi /Od /Oi /Zc:inline /fp:fast /std:c++latest  /D "_DEBUG" /D "TOM_INTERNAL" /D "_UNICODE" /D "UNICODE" /WX- /MTd  /FC  /EHsc /nologo
